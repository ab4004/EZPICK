		...
		<div class="w-25 mb-4 me-3 d-flex-column">
			<div class="card mb-3 d-flex-column">
				...
				<div class="mx-3 mb-3">
					...
					<a href="/board?category=자유" class="boardList_a"><div class="mb-2">자유</div></a>
					<a href="/board?category=유머" class="boardList_a"><div class="mb-2">유머</div></a>
					<a href="/board?category=사건" class="boardList_a"><div class="mb-2">사건사고</div></a>
				...
				<div class="mx-3">
					...
					<c:if test="${not empty topTen}">
						<c:forEach var="item" items="${topTen}">
							<a href="/board/detail/${item.boardSeq}" style="text-decoration: none; color: black;">
