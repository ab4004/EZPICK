...
<body>
		...
		<div class="container-fluid">
			...
			<ul class="navbar-nav mx-auto">
				<li class="nav-item" style="margin-right: 50px;"><a
					class="nav-link " href="/janAllDate?date=2024-01">1월</a></li>
				<li class="nav-item" style="margin-right: 50px;"><a
					class="nav-link active" href="/febAllDate?date=2024-02">2월</a></li>
				<li class="nav-item" style="margin-right: 50px;"><a
		...
		<div class="container-fluid">
			...
			<ul class="navbar-nav mx-auto">
				<li class="nav-item" style="margin-right: 40px;"><a
					class="nav-link" href="/febAllDate?date=2024-02"
					data-active="true">전체</a></li>
				<li class="nav-item" style="margin-right: 40px;"><a
					class="nav-link" href="/janAll?date=2024-02&team=젠지" data-active="true">젠지</a></li>
				<li class="nav-item" style="margin-right: 40px;"><a
					class="nav-link" href="/febAll?date=2024-02&team=T1" data-active="false">T1</a></li>
				<li class="nav-item" style="margin-right: 40px;"><a
					class="nav-link" href="/febAll?date=2024-02&team=KT 롤스터" data-active="false">KT</a></li>
				<li class="nav-item" style="margin-right: 40px;"><a
					class="nav-link" href="/febAll?date=2024-02&team=한화생명 e스포츠" data-active="false">한화생명</a></li>
				<li class="nav-item" style="margin-right: 40px;"><a
					class="nav-link" href="/febAll?date=2024-02&team=Dplus KIA" data-active="false">DK</a></li>
				<li class="nav-item" style="margin-right: 40px;"><a
					class="nav-link" href="/febAll?date=2024-02&team=피어엑스" data-active="false">피어엑스</a></li>
				<li class="nav-item" style="margin-right: 40px;"><a
					class="nav-link" href="/febAll?date=2024-02&team=광동 프릭스" data-active="false">광동</a></li>
				<li class="nav-item" style="margin-right: 40px;"><a
					class="nav-link" href="/febAll?date=2024-02&team=OK저축은행 브리온" data-active="false">OK저축은행</a></li>
				<li class="nav-item" style="margin-right: 40px;"><a
					class="nav-link" href="/febAll?date=2024-02&team=DRX" data-active="false">DRX</a></li>
				<li class="nav-item" style="margin-right: 40px;"><a
					class="nav-link" href="/febAll?date=2024-02&team=농심 레드포스" data-active="false">농심</a></li>
			</ul>
	...
	<div class="container mt-3">
		...
		<c:forEach items="${febAll}" var="book" varStatus="loop">

			<c:if test="${loop.index eq 0 || febAll[loop.index - 1].time.toLocalDate() ne book.time.toLocalDate()}">
