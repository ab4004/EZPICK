							...
							<div class="m-2">
								<h2>
									<strong>${account.gameName}</strong><span
										style="color: #9e9eb1; font-size: 0.5em"> #${account.tagLine}</span>
								</h2>
								<h5>
								...
								<c:choose>
									<c:when test="${!empty soloRank}">
										<div class="d-flex flex-fill justify-content-center">
											<img class="align-self-center" src="/img/rank/${soloRank.tier}.png" alt="티어" width="100px" height="100px">
										</div>
							...
							<div class="d-flex flex-column text-center w-25">
								...
								<c:choose>
									<c:when test="${!empty flexRank}">
										<div class="d-flex flex-fill justify-content-center">
											<img class="align-self-center" src="/img/rank/${flexRank.tier}.png" alt="티어" width="100px" height="100px">
										</div>
										<strong>${flexRank.tier} ${flexRank.rank}</strong>
									</c:when>
									<c:otherwise>
										<div class="d-flex flex-fill justify-content-center">
											<span class="align-self-center">NO-TIER</span>
										</div>
										<strong>UNRANK</strong>
									</c:otherwise>
								</c:choose>
									...
									<c:if test="${participant.win ne true}">
										<div class="d-flex card py-2 px-3 my-3" style="border-left: 6px solid #e84057; background-color: #fef9f9">
											<div class="d-flex">
    											...
    											<c:set var="play_time" value="${(currentDate.toEpochMilli() - match.info.gameEndTimestamp) div 1000}"/>
    											<c:choose>
    												<c:when test="${play_time < 0}">
            											<div>0초 전</div>
        											</c:when>
       												<c:when test="${play_time >= 31536000}">
            											<div><fmt:formatNumber value="${play_time div 31536000}" pattern="#0"/>년 전</div>
        											</c:when>
       												<c:when test="${play_time >= 2592000}">
       													<div><fmt:formatNumber value="${play_time div 2592000}" pattern="#0"/>개월 전</div>
       												</c:when>
       												<c:when test="${play_time >= 86400}">
      													<div><fmt:formatNumber value="${play_time div 86400}" pattern="#0"/>일 전</div>
      												</c:when>
      												<c:when test="${play_time >= 3600}">
      													<div><fmt:formatNumber value="${play_time div 3600}" pattern="#0"/>시간 전</div>
      												</c:when>
      												<c:when test="${play_time >= 60}">
      													<div><fmt:formatNumber value="${play_time div 60}" pattern="#0"/>분 전</div>
     												</c:when>
      												<c:otherwise>
      													<div><fmt:formatNumber value="${play_time}" pattern="#0"/>초 전</div>
      												</c:otherwise>
    											</c:choose>
											</div>
										<!-- 해당 매치 소환사 본인의 K/D/A -->
											...
											<div class="d-flex">
												...
												<div class="d-flex flex-column mx-2">
													<img src="/img/spell/${participant.summoner1Id}.png"
														alt="스펠1" width="32px" height="32px" /> <img class="mt-2" 
														alt="스펠2" src="/img/spell/${participant.summoner2Id}.png"
												...
												<div class="d-flex flex-column">
													<div class="d-flex">
													<img class="mx-2" src="https://ddragon.leagueoflegends.com/cdn/14.2.1/img/item/${participant.item0}.png" onerror="this.onerror=null; this.src='default-image.png'; this.alt='아이템'" width="32px" height="32px">
													<img class="mx-2" src="https://ddragon.leagueoflegends.com/cdn/14.2.1/img/item/${participant.item1}.png" onerror="this.onerror=null; this.src='default-image.png'; this.alt='아이템'" width="32px" height="32px">
													<img class="mx-2" src="https://ddragon.leagueoflegends.com/cdn/14.2.1/img/item/${participant.item2}.png" onerror="this.onerror=null; this.src='default-image.png'; this.alt='아이템'" width="32px" height="32px">
													<img class="mx-2" src="https://ddragon.leagueoflegends.com/cdn/14.2.1/img/item/${participant.item3}.png" onerror="this.onerror=null; this.src='default-image.png'; this.alt='아이템'" width="32px" height="32px">
													<img class="mx-2" src="https://ddragon.leagueoflegends.com/cdn/14.2.1/img/item/${participant.item4}.png" onerror="this.onerror=null; this.src='default-image.png'; this.alt='아이템'" width="32px" height="32px">
													<img class="mx-2" src="https://ddragon.leagueoflegends.com/cdn/14.2.1/img/item/${participant.item5}.png" onerror="this.onerror=null; this.src='default-image.png'; this.alt='아이템'" width="32px" height="32px">
													<img class="mx-2" src="https://ddragon.leagueoflegends.com/cdn/14.2.1/img/item/${participant.item6}.png" onerror="this.onerror=null; this.src='default-image.png'; this.alt='아이템'" width="32px" height="32px">
													</div>
													<div class="d-flex">
