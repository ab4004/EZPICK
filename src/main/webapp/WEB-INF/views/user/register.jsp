						...
						<div class="card-body">
							...
							<div class="mb-3">
								<label for="userEmail">이메일:</label> <input type="email"
									...
									onblur="userObject.validateUserEmail()" required> <span
									id="userEmailError" style="color: red;"></span>
							</div>
							<div class="d-grid">
							...
							<div class="mb-3" style="display: none" id="userInfoSection"
								...
								<div class="mb-3 mt-3">
									<label for="id">아이디:</label> <input type="text"
										...
										name="id" onblur="userObject.validateUserId()" required>
							...
							<div id="confirmButtonSection" style="display: none">
								<div class="d-grid">
									<button class="btn btn-primary"
										onclick="userObject.registerUser()" id="register-user">확인</button>
								</div>
							</div>
						</div>
					</div>
