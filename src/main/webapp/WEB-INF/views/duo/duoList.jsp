	...
	<div class="container mt-3">
		<div class="flex-grow-1 d-flex">
			...
			<div class="position-images">
				<img src="/img/position/fill.png"></img> <img
					src="/img/position/top.png"></img> <img src="/img/position/jgl.png"></img>
				<img src="/img/position/mid.png"></img> <img
					src="/img/position/bot.png"></img> <img src="/img/position/spt.png"></img>
			</div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
								...
								<div style="display: flex; gap: 10px;">
									<div>
										<label class="form-label">큐 타입</label><select
											class="form-select" id="queueModal">
											<option value="솔로랭크">솔로랭크</option>
											<option value="자유랭크">자유랭크</option>
											<option value="일반">일반</option>
											<option value="칼바람">칼바람</option>
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-primary" id="find-duo">글등록</button>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="card-container">
			<c:forEach var="list" items="${duoList }">
				<div class="card">
					<div class="card-header">${list.duoGameType } ${list.duoTier } 
						${list.duoPosition } 구함</div>
					<div class="card-body" style="height: 100px">${list.duoContent }</div>
					<div class="card-footer">${list.duoNickname }
						${list.duoWrtDate }</div>
				</div>
			</c:forEach>
		</div>
