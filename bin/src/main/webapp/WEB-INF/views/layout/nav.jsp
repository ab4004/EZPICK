...
<body style="font-family: 'Noto Sans KR', sans-serif;">
	<nav class="navbar navbar-light bg-light sticky-top" style="background-color: #EEEEEE">
		...
		<div class="container-fluid px-5">
			...
			<div class="d-flex justify-content-center">
				<div class="btn-group nav_menu">
					<a class="navbar-brand mx-3" href="#">패치노트</a> <a
						class="navbar-brand mx-3" href="#">커뮤니티</a> <a
			...
			<!-- 로그인 영역 -->
			<a class="navbar-brand nav_sign" href="#signup"><i
